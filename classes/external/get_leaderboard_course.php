...
/**
 * This file contains the class that define the get_leaderboard_course external function.
 * 
 * This function is used to retriee the HTML content to shape the leaderboard of a course.
 *
...
use external_value;
use block_xp_local\local\course_user_leaderboard;
...
/**
 * External function 'local_soluttolms_core_get_leaderboard_course' implementation.
 *
 * @package     local_soluttolms_core
 * @category    external
 * @copyright   2022 Solutto Consulting <devs@soluttoconsulting.com>
 ...
 */
class get_leaderboard_course extends external_api {
